...
<head>
	...
	<title>Sign in to Kabeer's Network Account</title>
		...
		<div class="container-fluid">
			<div class="valign-wrapper screenHeight">
					<div class="col card s12 m8 l6 xl4 autoMargin setMaxWidth overflowHidden">
						...
						<p class="center-align pad-no mar-no">Continue to <span class="text-primary">Kabeer's Network</span><br><small>Enter your Kabeer's Network Account</small></p>
