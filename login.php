<?php
  header('login.php?url='.strip_tags($_GET['redirect']).'&clientId='.strip_tags($_GET['clientId']).'&name='.strip_tags($results['name']).'');
          
if(isset($_GET['name'])&&isset($_GET['clientId'])&&isset($_GET['url'])){
  echo'
<!DOCTYPE>
<html>
<head>
